...
Public Class FrpcPanel
    ...
    Public Sub _init_(ByVal token As String, ByVal Assets As AssetModel, ByVal Api As String, ByVal Apitoken As String)
        Me.Assets = Assets
        Me.Token = token
        Me.Api = Api
        If Me.Api = "api.openfrp.net" Then
            Me.Apitoken = "&apitoken=LTW9yDKEfYJnzrqv"
        Else
            Me.Apitoken = ""
        End If
    ...
    Private Sub LoadProxys()
        Try
            ...
            fctn.getFrpcConfigCollection(Api, Me.Apitoken)
