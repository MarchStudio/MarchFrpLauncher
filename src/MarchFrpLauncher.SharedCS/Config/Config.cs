...
namespace MarchFrpLauncher.UI
{
    public partial class Config
    {
        ...
        /// </summary>
        public static readonly string FolderPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MarchFrpLauncher";
        ...
        /// config.ini的位置
        /// </summary>
        public readonly string configpath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MarchFrpLauncher\\config.ini";
